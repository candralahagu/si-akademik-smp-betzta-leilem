...
use App\Http\Controllers\SiswaPengumpulanController;
use App\Http\Controllers\GuruPengumpulanController;

// ==========================
// ROUTE TUGAS - GURU & SISWA
// ==========================

// ✅ GURU - Tugas
Route::middleware(['auth'])->prefix('guru')->group(function () {
    Route::get('/tugas', [GuruTugasController::class, 'index'])->name('guru.tugas.index');
    Route::get('/tugas/create', [GuruTugasController::class, 'create'])->name('guru.tugas.create');
    Route::post('/tugas', [GuruTugasController::class, 'store'])->name('guru.tugas.store');
    Route::get('/tugas/{id}/edit', [GuruTugasController::class, 'edit'])->name('guru.tugas.edit');
    Route::put('/tugas/{id}', [GuruTugasController::class, 'update'])->name('guru.tugas.update');
    Route::resource('tugas', GuruTugasController::class)->names('guru.tugas');
    Route::get('/tugas/{id}/pengumpulan', [GuruPengumpulanController::class, 'index'])->name('guru.tugas.pengumpulan');

});

// ✅ SISWA - Tugas
Route::middleware(['auth'])->prefix('siswa')->group(function () {
    Route::get('/tugas', [SiswaTugasController::class, 'index'])->name('siswa.tugas.index'); // Lihat tugas
    Route::post('/tugas/kumpul', [SiswaPengumpulanController::class, 'store'])->name('siswa.tugas.kumpul'); // Kirim tugas
});

Route::get('/', function () {
    return view('landing'); // tampilkan landing.blade.php
})->name('landing');
